...
export default function Contacts() {
    ...
    return (
        // <Stack sx={{ zIndex: 0, position: 'absolute', width: '100%', minHeight: '100vh', backgroundImage: `url(https://source.unsplash.com/featured)`, filter: 'blur(0px)', backgroundPosition: 'center', backgroundRepeat: 'no-repeat', backgroundSize: 'cover' }}>
        // </Stack>
        <Layout>
