...
const getStaticProps = async (context)=>{
    ...
    // });
    const products = await external_axios_default().get(`${"https://api.localshop.lt"}/api/products?populate=*`);
    // await shopify.order
    //   .get(5727615123802)
...
var __webpack_exports__ = __webpack_require__.X(0, [312,664,719,675,798,648,375,74,246], () => (__webpack_exec__(6628)));
